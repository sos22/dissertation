...
\begin{figure}
  \begin{center}
  \begin{tikzpicture}
    \node (l1) at (0,2) [stateSideEffect] {l1: \stLoad{tmp1}{\mathrm{global\_ptr}} };
    \node (l2) [stateIf, below=of l1] {l2: \stIf{0 == \smTmp{1}}};
...
\begin{sidewaysfigure}
  \begin{tikzpicture}
    ...
    \node (lD) [stateIf, below = of lB] { l2: \stIf{0 == \smTmp{1}} };
...
\caption{{\STateMachine} generated from the CFG shown in
  Figure~\ref{fig:cyclic_cfg}. \todo{This is a bit of an abuse:
    {\StateMachine} language separates temporaries and registers, and
...
in the {\stSurvive} state\editorial{i.e. taking all paths which
  definitely survive, and excluding those which crash and which reach
  {\stUnreached}.}.  The inferred assumption itself is then formed
