...
the need to solve a large number of aliasing problems.  This can be
...
the interfering one.  This amounts to restricting the class of bugs
...
\item {\Implementation} assumes that the program does not make use of
  ...
  possible\editorial{Evidence?}.  This is therefore a reasonable
