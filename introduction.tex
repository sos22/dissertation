...
\smh{Move to eval, or generally later}
...
Suppose now that the ordering violation bug is transformed to the one
...
\smh{Need a thesis statement explicitly somewhere}
