...
edges then a warning is raised\editorial{I could describe the VC
algorithm itself here, but it has an annoying number of special cases
and it doesn't really add anything.}.  Recent tools of this form
...
Something about detecting OS-mediated races?
...
systems, such as Clara\editorial{Cite Bodden, Lam, Hendren 2012.
Might also want to reference chain from there.}, attempt to split the
...
\todo{This is less relevant than it used to be.}
