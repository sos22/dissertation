...
\begin{sidewaysfigure}
  ...
  \begin{tabular}{l>{\RaggedRight\arraybackslash}p{5.5cm}lp{10.3cm}}
    ...
    \hgreyline
    Typestate systems~\cite{Strom1986a}& \multirow{2}{*}{\parbox{5.5cm}{Object access protocol sequencing violations}} & Dynamic & Gradual typestates~\cite{FFFWolff2011}, 2ndStrike~\cite{Gao2011} \\
...
the tool flags a potential concurrency error\fnote{There is an
...
at run time~\cite{FFFWolff2011}, whether in an
...
systems in use today; it is certainly more so than the quite primitive
...
terms of the inputs to the program\fnote{KLEE itself can be
  ...
  under test.}.  It would be possible to combine the two techniques
...
the techniques presented in the paper\fnote{The paper only considers
  ...
  patterns deferred to future work.}, making the technique's
generality questionable.  Beyond this, ConTest also suffers the more
