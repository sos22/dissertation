...
terms of the inputs to the program\footnote{KLEE itself can be
  ...
  under test.}\hspace{-.9ex}.  It would be possible to combine the two
...
the techniques presented in the paper\footnote{The paper only
  ...
  complicated patterns deferred to future work.}\hspace{-1ex}, making
the technique's generality questionable.  Beyond this, ConTest also
