...
\begin{sidewaysfigure}
  ...
  \begin{tabular}{l>{\RaggedRight\arraybackslash}p{5.5cm}lp{10.3cm}}
    ...
    \hdashline
    Extended assertions        & \multirow{2}{*}{\parbox{5.5cm}{Violations of programmer-identified properties}} & Dynamic        & TESLA~\cite{Locielski2011,Watson2013}\editorial{Need a better cite}, Uppuluri et al.~\cite{Uppuluri2005} \\
  ...
  \caption{Summary of some existing bug detection and characterisation
    techniques. \todo{Not convinced I really want to jam these into
      the same table.}}
...
\todo{Linkage?} The chief approximation made by RacerX's static
...
\todo{Possibly a bit too informal.} These techniques could be used to
...
so must have false negatives.  \todo{Bit of an odd para ending.}
...
The TESLA project~\cite{Locielski2011,Watson2013}\editorial{still need
...
only a binary program.  \todo{Not quite sure what that paragraph was
  trying to achieve.}
