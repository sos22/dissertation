...
\todo{AFix?  CFix?  Both very relevant, and not currently mentioned.
  (Largely because they were published after I wrote that bit of the
  related work section, but still.)}
...
these techniques might produce interesting results.  \todo{Might be
  worth comparing their analysis more explicitly to the stuff in the
  program model chapter.} \todo{Maybe cite the WYSINWYX paper here as
  well?  It's basically the same as CodeSurfer, but I guess it
  wouldn't hurt to mention it explicitly.}
