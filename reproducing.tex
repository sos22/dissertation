...
transformation on the BDD which represents the
\gls{verificationcondition}.  Consider, for instance, the graph shown
in \autoref{fig:reproducing:placement_eg_bug}.  This is intended to
...
The computational complexity of BDD re-ordering operations is, in the
