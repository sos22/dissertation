...
\begin{sanefig}
  ...
  \caption{The patch generating algorithm as a graph grammar.  The
    ...
    static \protect\gls{cfg} representing the \gls{shadowfragment}.
...
synchronisation\footnote{At the level of the graph grammar, this means
  ...
  \graphNT{X, $\varnothing$, $\mathit{unheld}$, \textbf{Return}} when lock
...
aversion techniques such as Gaddara~\cite{Wang2008} or
