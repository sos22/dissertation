...
\begin{sanefig}
  ...
  \caption{The patch generating algorithm as a graph grammar.  The
    ...
    match.  \textrm{X} and \textrm{Y} match fragments of the static
...
using existing deadlock aversion techniques such as
Gaddara\cite{Wang2008} or Dimmunix\cite{Jula2008}, or even a simple
adaptive timeout mechanism.  I have not found any bugs in real
programs where these deadlocks happen with sufficient frequency to be
a practical problem, and so have not investigated these strategies in
detail.
