...
\begin{sanefig}
  ...
  \caption{The initial set of non-terminals for the graph grammar in
    ...
    non-terminal for every entry in the $\mathit{Patch}$ set. \smh{How is Patch calculated?}}
...
\item $\mathit{adv}(\mathrm{X}, \alpha)$, where $\mathrm{X}$ is a
  ...
  corresponding to $r$.  \smh{Call out similarities to enforcer power
    set construction more explicitly?}
\end{itemize}
