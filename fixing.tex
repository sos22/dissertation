...
\texttt{8b}; or, equivalently, it must decide whether to use two
critical sections, each covering a single instruction, or a single
section which covers both.  Either approach will correctly eliminate
the bug, but with different performance characteristics: dropping and
...
generate streams of instructions, and
the dynamic one
