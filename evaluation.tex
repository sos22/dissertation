...
\todo{10\% is still massively more than I was expecting for this test.
  Should investigate why it's so big.}
...
\begin{figure}
  \subfigure[][Without enforcer]{ \todo{There will be a chart here
      showing how the reproduction time varies with NR\_PTRS, between
      0 and 5000.  This will include the median, mean, 25th
      percentile, and 75th percentile reproduction times.}  }
  \subfigure[][With enforcer]{ \todo{Likewise} }
...
\todo{Things to include here:
  \begin{itemize}
  \item Time taken to do the static analysis phase.
  \item Time taken to do the main analysis pass with W isolation.
  \item Time taken to do the main analysis pass without W isolation.
  \item Time taken to build the enforcer.
  \item CDFs showing how long it takes to repro without an enforcer,
    with an enforcer, and under the DC-like tool.
  \item Performance overhead with a fix loaded.
  \end{itemize}
}
...
\todo{Might be worth pointing out that the fix can lead to
