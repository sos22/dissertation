...
Resampling the time taken without an enforcer gave me that the lambda
parameter is 0.38 with an sd of 0.008, but I'm not entirely convinced
that's normally distributed.  In fact I'm pretty certain that it's
not.
