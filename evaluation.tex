...
\todo{Not sure how much this adds, to be honest.} This test consists
of the labyrinth component of the STAMP benchmark suite\needCite{},
converted to use locks rather than transactional memory and with one
of its critical sections removed.  It is shown in
...
behaviour, and how much \todo{does it slow the program down while it
  is being analysed}?  I investigate the first concern first.
