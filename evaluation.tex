...
\gls{crashingthread} (see \autoref{sect:derive:build_static_cfg}),
which in this case is straightforward; the result is shown in
\autoref{fig:eval:simple_toctou:cfg}.  This can then be compiled to
...
\autoref{fig:eval:existing_sync:invisible}.  As such, it generates
...
Silverman's Rule of Thumb\needCite{}.  The chart also shows the mean
excluding timeouts, plus or minus one standard deviation of that mean,
as a hollow gray rectangle.
