...
\todo{Conversion to enforcers?}  \todo{How
  long do the enforcers take to run?}  \todo{Timeout settings?}
\todo{How many VCs generated?}  \todo{Version of pbzip2?}
\todo{Compile settings?}  \todo{Value of $\alpha$?}
