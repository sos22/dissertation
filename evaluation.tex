...
\begin{sanetab}
  \begin{tabbular}{|p{1.9cm}| r@{.}l@{}c@{}r@{.}l | c@{}r@{.}l@{,~}r@{.}l@{}l | c@{}r@{.}l@{,~}r@{.}l@{}l | c@{}r@{.}l@{,~}r@{.}l@{}l|}
    ...
    \cline{7-24}
    Phase & \multicolumn{5}{c|}{Mean} & \multicolumn{6}{c|}{$5^{th}$\%} & \multicolumn{6}{c|}{$50^{th}$\%} & \multicolumn{6}{c|}{$95^{th}$\%}  \\
    \hline
...
\begin{sanetab}
  ...
  \caption{Time taken, in nanoseconds, for the {\!\rm \bugname{nobug}\!} test to
    ...
    descriptions of the types of fix used. \smh{What is overhead?  Align,prec}}
