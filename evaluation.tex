...
\item Need to re-do the phase breakdown experiments.
\end{itemize}
...
\item The boxes above and below the PDFs give the number of
  ...
  possible.  \autoref{tab:eval:how:failures_per_crashing} gives more
  details of the failures encountered during this phase.
  \begin{sanetab}
    \begin{tabbular}{|p{5.3cm}|p{2.9cm}|p{2.9cm}|p{2.9cm}|}
      ...
      \RaggedRight Derive C-atomic & 3678 & 1 & 4 \\
      \hline
    \end{tabbular}
...
in the CDFs.  These are accounted for by various special cases within
{\implementation}:
\begin{itemize}
...
\begin{sanefig}
  ...
  \caption{Time taken to convert the 4355
...
\begin{sanetab}
  \begin{tabbular}{|p{5.6cm}|p{2.8cm}|p{2.8cm}|p{2.8cm}|}
    ...
    \hline
    Extract happens-before graph & 4355 & 31 & 27 \\
    Place side conditions        & 4297 & 0  & 3 \\
    Compile                      & 4294 & 0  & 4 \\
    \hline
  \end{tabbular}
...
\item Extracting the happens-before graph, as discussed in
  ...
  reasonably quick, with a median time of 20ms, but occasionally takes
  a very long time, reaching the five minute timeout in 31 of the 4355
