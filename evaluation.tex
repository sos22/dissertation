...
probability of crashing before reaching the timeout fell from 27\% to
\todo{...}).  If the \texttt{STOP\_ANALYSIS()} marker is removed then
both bugs are discovered, and the resulting fix prevents the program
from crashing.
...
\todo{Basic approach here is going to be to take a random sample of
  ...
  you spend a lot of your time in the outliers.  I'll then show how
  that changes when you change $\alpha$.  Also need to show how the
  number of candidates varies with $\alpha$.}
