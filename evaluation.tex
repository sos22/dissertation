...
\bugname{thunderbird}, the problem was the lack of knowledge of the
...
happening.  The \bugname{mysql} false positive, by contrast, was
...
\begin{sanetab}
  \begin{tabbular}{|p{3.9cm}|p{10.75cm}|}
    ...
    \hline
    \bugname{mysql}      & $287 \pm_\mu^{10} 3$ \\
    \bugname{thunderbird} & $373 \pm_\mu^{10} 3$ \\
    \hline
  \end{tabbular}
...
\hline
\end{tabbular}
\caption{Effectiveness of {\implementation} at finding unknown bugs. This
...
time taken was unchanged.\kern-.5pt\fnote{In fact, the average time taken
...
$N$\kern-1pt.\kern.5pt\fnote{Memory consumption on this test was 4MiB on the smallest
...
\begin{sanefig}
  ...
  \caption{Time taken to reproduce the \bugname{complex\_hb}$_N$ test
    ...
    enforcer, the average reproduction time was
    $13.5~\in~[10.7,16.5]_{1000}^{100}$ seconds when $N=2$; at $N=3$
    and $N=4$, there were no reproductions in under ten minutes in 100
...
features.\kern-1pt\fnote{This model is, however, a poor quantitative fit for
...
\autoref{fig:eval:why:complex_aliasing:result2}.  As expected,
        ...
        far larger values of $L$.\kern1pt\fnote{The largest successful value of
