...
reasonable lower bound on the time which {\implementation} might take
...
with {\implementation} configured to make minimal use of the dynamic
...
\begin{sanetab}
  ...
  \caption{Effect of the \glsentrytext{programmodel} on analysis
    effectiveness.  For the static disabled column, {\implementation}
