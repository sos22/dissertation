...
\glspl{verificationcondition} generated.

\todo{This is going to be pretty cursory: just run it once with the W
  isolation assumption made, then again without the assumption, and
  see how many additional VCs we need, how many more timeouts we get,
  and how much longer it takes when we don't get timeouts.}
