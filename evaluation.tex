...
completed the crashing thread loop $9.6 * 10^5 \pm 0.5 * 10^5$ times
per second and the interfering thread loop $9.0 \pm 0.2 * 10^5$ times
per second; with a fix, it completed $8.3 * 10^5 \pm 0.3 * 10^5$
crashing loops and $7.8 * 10^5 \pm 0.2 * 10^5$ interfering loops (mean
