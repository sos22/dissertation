...
\begin{table}
  ...
  \caption{Performance of some variants of the fix, in millions of
    ...
    deviation of ten runs, each for ten seconds.}
...
estimated in log space using a kernel density estimator and a
...
\begin{figure}
  \centerline{\input{eval/alpha/unopt/gsc.tex}}
...
the parts of the {\StateMachine} simplifications and the symbolic
