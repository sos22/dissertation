...
\item pbzip2 text needs rewriting,
...
\item Converting the \glspl{verificationcondition} to
  \glspl{bugenforcer} took $950 \pm 2$ seconds, mean and standard
  deviation of mean for ten runs, or a little over quarter of an hour.
\end{itemize}
...
\ref{fig:eval:dyn_convergence:thunderbird}, and \todo{do pbzip2 test},
...
This is arguably a somewhat unfair test: taking a snapshot can itself
take several hundred milliseconds, depending on how complete the
...
\begin{figure}
  ...
  \caption{Dynamic aliasing coverage against time for MySQL}
