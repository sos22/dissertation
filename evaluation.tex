...
\begin{sanetab}
  ...
  \begin{tabular}{|p{3.3cm}|p{5.7cm}|p{5.7cm}|}
    \hline
    Test program              & \Gls{programmodel}      & \Glspl{verificationcondition} \\
    \hline
  ...
  \caption{Time taken to build \gls{programmodel} and generate \glspl{verificationcondition} for
    the artificial bugs.}
...
\begin{sanetab}
  ...
  \begin{tabular}{|p{3.3cm}|p{5.7cm}|p{5.7cm}|}
    \hline
    Test program & Time building enforcer & Time building fix\\
    \hline
    \bugname{toctou}          & $0.206 \pm^{10}_p 0.008$s & $0.142 \pm^{10}_p 0.004$s\\
    \bugname{multi\_variable} & $0.207 \pm^{10}_p 0.006$s & $0.135 \pm^{10}_p 0.004$s \\
    \bugname{double\_free}    & $0.199 \pm^{10}_p 0.009$s & $0.135 \pm^{10}_p 0.003$s \\
    \hline
  \end{tabular}
  }
  \caption{Time taken to build \glspl{bugenforcer} and fixes for the
    artificial test programs. \todo{Smooshing them together doesn't
      fit structure, but giving them separate tables looks really
      ugly.}}
...
\begin{sanetab}
  ...
  \caption{Time taken to build \gls{programmodel} and
