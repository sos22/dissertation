...
\begin{sanetab}
  ...
  \begin{tabbular}{|l|l|l|l|l|}
    \hline
                                  & \multicolumn{2}{c|}{Thread iteration time, ns} & \multicolumn{2}{c|}{Overhead, ns} \\
    \cline{2-5}
  ...
  \caption{Time taken by the {\!\rm \bugname{nobug}\!} test to
...
100\% overhead, and the full fix, which requires lock contention, adds
1$\mu$s to each crashing iteration and 1.3$\mu$s to each interfering
one.  These results suggest that most of the overhead of
...
realising that scheme.  Further improvements to performance will
