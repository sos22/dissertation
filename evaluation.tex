...
following sections examine each phase in turn. \todo{blerg}
...
\item The ``Total'' PDF gives the distribution of the total time taken
  ...
  \begin{sanetab}
    \begin{tabbular}{|p{3cm}|p{3.2cm}|p{2.55cm}|p{2.6cm}|p{2.7cm}|}
      ...
      \hline
      \subcrash{0} & 10000 & 1969 & 0 & 0 \\
      \subcrash{1} & 8031 & 0 & 1 & 0 \\
      \subcrash{2} & 8030 & 0 & 2 & 0 \\
      \subcrash{3} & 8028 & 4350 & 0 & 0 \\
      \subcrash{4} & 3678 & 0 & 1 & 2 \\
      \subcrash{5} & 3675 & 0 & 0 & 1 \\
      \hgreyline
    ...
    \caption{Failures and early dismissals during phase \subcrash{}.
      ...
      step. \todo{Fix me: ratios and confidence intervals.}}
...
\begin{sanetab}
  \begin{tabbular}{|p{3.74cm}|p{3.38cm}|p{2.14cm}|p{2.14cm}|p{2.69cm}|}
    ...
    \hline
    \subinterfering{0}         & 27535                     & 0         & 21          & 1 \\
    \subinterfering{1}         & 23513                     & 0         & 44          & 0 \\
    \subinterfering{2}         & 23471                     & 10416     & 0           & 0 \\
    \subinterfering{3}         & 13055                     & 0         & 47          & 35 \\
    \subinterfering{4}         & 12935                     & 0         & 1           & 0 \\
    \subinterfering{5}         & 12934                     & 0         & 47          & 0 \\
    \hgreyline
...
\begin{sanetab}
  \begin{tabbular}{|l|p{2.5cm}|p{2.5cm}|p{2.5cm}|p{2.5cm}|}
    ...
    \hline
    \subfix{0} & $0.53 \pm_\mu^{3870} 0.03$ & $[0.10,0.11]_{1000}^{3870}$ & $[0.25,0.26]_{1000}^{3870}$ & $[1.2,1.5]_{1000}^{3870}$ \\
    \subfix{1} & $7.3 \pm_\mu^{3870} 0.3$   & $[0.33,0.37]_{1000}^{3870}$ & $[0.87,0.89]_{1000}^{3870}$ & $[35,41]_{1000}^{3870}$ \\
    \subfix{2} & $1.79 \pm_\mu^{3870} 0.09$ & $[0.24,0.27]_{1000}^{3870}$ & $[0.54,0.57]_{1000}^{3870}$ & $[5.6,10]_{1000}^{3870}$ \\
    \subfix{3} & $104.5 \pm_\mu^{3870} 0.2$ & $[85.9,86.8]_{1000}^{3870}$ & $[104,106]_{1000}^{3870}$   & $[120,122]_{1000}^{3870}$ \\
    \hgreyline
  ...
  \caption{Time taken to convert the 3870
    ...
    experiment. \todo{width} \smh{align digits, equal precision}}
...
\begin{sanetab}
  ...
  \caption{Effect of {\StateMachine} simplification on analysis
    ...
    re-collected for this table.  \smh{align digits, equal precision.}}
...
\begin{sanetab}
  \begin{tabbular}{|l|l|l|}
    ...
    \hline
  \end{tabbular}
  \caption{Effect the \glsentrytext{w-isolation} assumption on analysis
    effectiveness. All times in seconds.  *: Excluding failures in the
    per-crashing instruction phase. $\dagger$: Excluding failures in
    either phase.}
...
\begin{sanetab}
  ...
  \caption{Time taken, in nanoseconds, for the {\!\rm \bugname{nobug}\!} test to
    ...
    descriptions of the types of fix used. \smh{What is overhead?}}
