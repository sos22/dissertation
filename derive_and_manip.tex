...
\todo{Having written this down, I think is a really stupid approach,
  and experimentally it's also one of the big bottlenecks in the
  analysis.  Might end up reworking this into something a bit less
  crazy.  I'm also pretty confident that I'd have gotten better
  results if I'd used BDD a bit more consistently, and if I end up
  switching the rest of the analysis over to them then that'll also
  require some re-working of this section.}

\todo{Also, the only reason this can ever fail is the
...
\item
  ...
  lowest final entropy.  \todo{I really don't have much reason to
    believe that that's a good heuristic.}  Note that this implies
