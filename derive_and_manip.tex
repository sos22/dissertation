...
\item Finally, the \backref{summary} is converted to \introduction{static
...
\subsection{Generalising to finding unknown bugs}
...
\begin{tikzpicture}
  ...
  \node[stateIf,below = of l2] (l3) {If $\controlEdge{threadId}{A}{B}$};
