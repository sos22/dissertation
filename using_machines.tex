...
\todo{I have a new theory for describing this: start by describing how
  to check whether a bug has reproduced, then explain how to turn that
  into an enforcer.}
...
{\Technique} avoids this problem using a simple message-passing
...
\todo{This is often rather expensive, and is always rather stupid.
  ...
  $\happensBeforeEdge$ variables to the root of the DAG, at which
  point it all becomes trivial.}
