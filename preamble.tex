...
\newenvironment{sanefig}{\begin{figure}[tp]\begin{mdframed}}{\end{mdframed}\end{figure}}
\newenvironment{sanetab}{\begin{table}[tp]\begin{mdframed}}{\end{mdframed}\end{table}}
\newenvironment{sanewrapfig}[1]{\begin{wrapfigure}{O}{#1}\begin{mdframed}}{\end{mdframed}\end{wrapfigure}}
